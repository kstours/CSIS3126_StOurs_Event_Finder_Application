...
class eventAdapter3(private val eventList:ArrayList<eventData>, private val ctx:Context) : RecyclerView.Adapter<eventAdapter3.MyViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.list_myevents,parent,false)
