...
class eventAdapter5(private val eventList:ArrayList<eventData>, private val ctx: Context) : RecyclerView.Adapter<eventAdapter5.MyViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.list_rsvp,parent,false)
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        val storageRef = FirebaseStorage.getInstance().getReference("images/events/${currentItem.name}+${currentItem.author}").downloadUrl.addOnSuccessListener {
            ...
            holder.itemView.setOnClickListener{
                ...
                intent.putExtra("gobackto","profile")
